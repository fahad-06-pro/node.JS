...
server.bind(0, common.mustCall(async () => {
  ...
  // Test if the Resolver should work as before.
  ...
  // Test maxTimeout is effective
  // Without maxTimeout, the timeout will keep increasing when retry
  const timeout1 = await timeout(address, { timeout: 500, tries: 3 });
  // With maxTimeout, the timeout will always 500 when retry
